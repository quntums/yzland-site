export const metadata = {
  ...
  description: "Guide: is morocco safe for tourists with expert travel tips for Morocco.",
};

export default function Page() {
  return (
    <main className="px-6 py-12 max-w-3xl mx-auto space-y-6">
      <h1 className="text-4xl font-bold">Is Morocco Safe For Tourists</h1>

      <p className="text-gray-600">
        Is morocco safe for tourists is one of the most common questions travelers ask when planning a Morocco trip.
      </p>
